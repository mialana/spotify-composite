...
export default () => {
  ...
  return (
    <div className="login">
      <span className="logintext">Welcome to Spotify Composite! To get started, click on the button below.</span>
      <p><button className="loginbutton" onClick={handleLogin}><strong>Login to Spotify</strong></button></p>
    </div>
  );
};